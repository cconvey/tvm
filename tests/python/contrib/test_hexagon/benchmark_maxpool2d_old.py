...
class TestMaxPool2D:
    ...
    def test_maxpool2d_nhwc(
        ...
        a_hexagon = tvm.nd.empty(a_transformed.shape, dtype='int8', device=hexagon_session.device, mem_scope='global')
        c_hexagon = tvm.nd.empty(c_np.shape, dtype='int8', device=hexagon_session.device, mem_scope='global')
