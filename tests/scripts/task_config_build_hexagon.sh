...
if [[ ${CI:-false} == "true" ]]; then
    ...
    echo set\(CMAKE_CXX_COMPILER \"/mnt/data/r/cconvey/tvm/call-extern-ptr/llvm/llvmorg-15.0.6-RelWithDebInfo-install/bin/clang++\"\) >> config.cmake
    echo set\(CMAKE_C_COMPILER \"/mnt/data/r/cconvey/tvm/call-extern-ptr/llvm/llvmorg-15.0.6-RelWithDebInfo-install/bin/clang\"\) >> config.cmake
fi
